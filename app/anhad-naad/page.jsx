    ...
    <div className="page-wrapper rekhi-page" style={{ minHeight: '100vh', background: '#F4DEFA' }}>
      ...
      <section className="service-hero" style={{ backgroundImage: 'url(/anhadnaad_hero_bg.png)' }}>
        ...
        <div className="container-wide" style={{ padding: '0 20px' }}>
          ...
          <Link href="/contact" style={{ display: 'inline-block', padding: '16px 48px', background: '#F2DA91', color: '#1a0a2e', textDecoration: 'none', borderRadius: '50px', fontWeight: '700', transition: 'all 0.3s ease' }} onMouseEnter={(e) => e.currentTarget.style.transform='scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform='scale(1)'}>Host Anhad Naad</Link>
        </div>
      </section>
      ...
      <section className="responsive-section" style={{ background: 'var(--primary-purple)', color: 'white' }}>
        <div className="container-wide">
          ...
          <div style={{ textAlign: 'center', marginTop: '60px' }}>
            <Link href="/contact" style={{ display: 'inline-block', padding: '16px 48px', background: 'var(--accent-yellow)', color: '#1a0a2e', textDecoration: 'none', borderRadius: '50px', fontWeight: '700' }}>Inquire for Booking</Link>
          </div>
        </div>
      </section>
