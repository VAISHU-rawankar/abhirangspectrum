...
const Blog = () => {
  ...
  const blogs = [
    ...
    { id: 'graphology-personality-examples', category: "Graphology", title: "What Your Handwriting Says About Your Personality (With Examples)", excerpt: "Discover the hidden meanings behind your handwriting strokes and how they reveal your true personality traits.", date: "May 15, 2026", image: "/graph_personality.png", tags: ["Personality", "Analysis"] },
    { id: 'graphology-slanted-meaning', category: "Graphology", title: "Slanted Handwriting Meaning in Graphology Explained", excerpt: "Learn what forward, backward, or vertical handwriting slant says about your emotional expressions and boundaries.", date: "May 16, 2026", image: "/graph_slant.png", tags: ["Slant", "Emotions"] },
    { id: 'graphology-signature-analysis', category: "Graphology", title: "Signature Analysis: What Your Signature Reveals About You", excerpt: "Your signature is your public face. See what your signature style, size, and placement say about your confidence and self-image.", date: "May 17, 2026", image: "/graph_signature.png", tags: ["Signature", "Self-Image"] },
    { id: 'graphology-improve-change-personality', category: "Graphology", title: "How to Improve Handwriting to Change Personality", excerpt: "Graphotherapy uses conscious handwriting changes to rewire subconscious traits. Find out how altering your strokes can improve your life.", date: "May 18, 2026", image: "/graph_improve.png", tags: ["Graphotherapy", "Improvement"] },
    {
    ...
    { id: 'astrology-read-birth-chart', category: "Astrology", title: "How to Read Your Birth Chart (Step-by-Step for Beginners)", excerpt: "A simple, beginner-friendly guide to understanding houses, planets, and zodiac signs in your natal chart.", date: "May 19, 2026", image: "/astro_chart.png", tags: ["Birth Chart", "Beginners"] },
    { id: 'astrology-why-bad-luck', category: "Astrology", title: "Why You Are Facing Bad Luck According to Astrology", excerpt: "Explore planetary transits, doshas, and karmic cycles that might be causing sudden hurdles, and how to remedy them.", date: "May 20, 2026", image: "/astro_luck.png", tags: ["Karma", "Remedies"] },
    { id: 'astrology-most-powerful-zodiac', category: "Astrology", title: "Which Zodiac Sign Is Most Powerful and Why", excerpt: "Unpack the strengths, unique powers, and cosmic influence of each zodiac sign to see which ones dominate in different areas of life.", date: "May 21, 2026", image: "/astro_zodiac.png", tags: ["Zodiac", "Power"] },
    { id: 'astrology-planets-affect-life', category: "Astrology", title: "How Planets Affect Your Life (Simple Guide)", excerpt: "From the Sun to Saturn, learn how each planet's energy shapes your career, relationships, and health.", date: "May 22, 2026", image: "/astro_planets.png", tags: ["Planets", "Life Impact"] },
    {
    ...
    { id: 'numerology-calculate-life-path', category: "Numerology", title: "How to Calculate Your Life Path Number (Step-by-Step)", excerpt: "Your life path number reveals your ultimate destiny. Learn the simple calculation method to find yours today.", date: "May 23, 2026", image: "/numero_path.png", tags: ["Life Path", "Calculation"] },
    { id: 'numerology-lucky-number', category: "Numerology", title: "Which Number Is Lucky for You Based on Numerology", excerpt: "Find out your personal lucky numbers for career, business, and daily decisions using your birth date.", date: "May 24, 2026", image: "/numero_lucky.png", tags: ["Lucky Numbers", "Success"] },
    { id: 'numerology-name-correction', category: "Numerology", title: "Numerology Name Correction: Does It Really Work?", excerpt: "Can changing the spelling of your name alter your destiny? Discover the science of numeric vibrations behind name correction.", date: "May 25, 2026", image: "/numero_name.png", tags: ["Name Correction", "Vibration"] },
    { id: 'numerology-meaning-1-to-9', category: "Numerology", title: "Meaning of Numbers 1 to 9 in Numerology", excerpt: "A comprehensive guide to the core characteristics, strengths, and weaknesses of every root number from 1 to 9.", date: "May 26, 2026", image: "/numero_numbers.png", tags: ["Core Numbers", "Meaning"] },
    {
      id: 'vastu-harmony',
            ...
            {blogs.map((blog) => (
              <article key={blog.id} className="blog-card" style={{ background: '#F0D4F3', borderRadius: '15px', overflow: 'hidden', display: 'flex', flexDirection: 'column', boxShadow: '0 10px 30px rgba(79, 28, 76, 0.1)' }}>
                ...
                <div style={{ padding: '30px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                  ...
                  <Link href={`/blog/${blog.id}`} onClick={() => window.scrollTo({ top: 0, left: 0, behavior: 'instant' })} style={{ textDecoration: 'none' }}>
                    <h4 style={{ margin: '0 0 20px 0', fontSize: '20px', color: '#4F1C4C', fontWeight: '700', lineHeight: '1.4', transition: 'color 0.3s ease' }} className="blog-title-hover">
                      {blog.title}
                    </h4>
                  </Link>
                  ...
                  <div style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid rgba(79, 28, 76, 0.1)', paddingTop: '20px' }}>
                    ...
                    <Link href={`/blog/${blog.id}`} onClick={() => window.scrollTo({ top: 0, left: 0, behavior: 'instant' })} style={{ padding: '6px 14px', border: '1px solid #4F1C4C', borderRadius: '6px', color: '#4F1C4C', fontSize: '13px', textDecoration: 'none', transition: 'background 0.3s ease' }}>Read More</Link>
                  </div>
                </div>
              </article>
            ))}
