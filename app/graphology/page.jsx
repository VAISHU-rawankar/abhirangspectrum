    ...
    <div className="page-wrapper" style={{ minHeight: '100vh', background: '#FDF7FE' }}>
      ...
      <section className="service-hero" style={{ backgroundImage: 'url(/graphology_hero_bg.png)' }}>
        ...
        <div className="container-wide" style={{ padding: '0 20px' }}>
          ...
          <Link href="/contact" style={{ display: 'inline-block', padding: '16px 48px', background: '#F2DA91', color: '#1a0a2e', textDecoration: 'none', borderRadius: '50px', fontWeight: '700', transition: 'all 0.3s ease' }} onMouseEnter={(e) => e.currentTarget.style.transform='scale(1.05)'} onMouseLeave={(e) => e.currentTarget.style.transform='scale(1)'}>Consult Now</Link>
        </div>
      </section>
